...
SET DEFINE OFF;
Insert into C##LUDAN."Items" ("ItemID","ShopID","ItemPrice","ItemName","ItemInfo","ItemPic","ItemSales","ItemRemain") values ('12121','100001',219,'LILIFAN百搭锁骨项链','LILIFAN百搭锁骨项链','12122',243,500);
Insert into C##LUDAN."Items" ("ItemID","ShopID","ItemPrice","ItemName","ItemInfo","ItemPic","ItemSales","ItemRemain") values ('12122','100001',219,'LILIFAN百搭锁骨项链','LILIFAN百搭锁骨项链','12122',13,500);
...
Insert into C##LUDAN."Items" ("ItemID","ShopID","ItemPrice","ItemName","ItemInfo","ItemPic","ItemSales","ItemRemain") values ('13143','100001',360,'LILIFAN升记号戒指','LILIFAN莉莉梵设计师品牌戒指ins个性气质指环升记号开口镶钻戒指','13143',91,11);
...
Insert into C##LUDAN."Items" ("ItemID","ShopID","ItemPrice","ItemName","ItemInfo","ItemPic","ItemSales","ItemRemain") values ('11191','100001',245,'LILIFAN圆环旋转耳环','LILIFAN莉莉梵设计师品牌耳环气质ins玫瑰金耳钉曲面圆环旋转耳环','11191',902,284);
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Trigger ITEM_TRIGGERS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "C##LUDAN"."ITEM_TRIGGERS" 
BEFORE DELETE ON "Items" 
FOR EACH ROW
BEGIN
    DELETE "Comments" WHERE "ItemItemID" =:old."ItemID";
    DELETE "Browsings" WHERE "ItemID" =:old."ItemID";
END;
/
ALTER TRIGGER "C##LUDAN"."ITEM_TRIGGERS" ENABLE;
--------------------------------------------------------
